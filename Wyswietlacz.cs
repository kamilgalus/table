...
namespace TabelaiPionki
{
    class Wyswietlacz
    {
         int[] tablicaUstawionychPionkow = new int[5];   // tablica ktora będzie przechowywać inforamcje ktory pionek z koleji stoi na ktortym miejscu
        ...
        */
        ...
        public void UstawienieKolejnychPionkow(int nrPionka, int nrMiesjca, Wyswietlacz o)  //Ustawia cyfry(nr pionka) na miejscu wybieranym przez uzytkownika 
        {
            o.tablicaUstawionychPionkow[nrMiesjca - 1] = nrPionka + 1;
        }
        ...
        public void WyswietlaniePozycjiPionków(Wyswietlacz o)  // Pokazuje położenie konkretnego Pionka na przydzielonym mu miejscu 
        {
            ...
            for (int j = 1; j <=5; j++)
            {
                ...
                for (int i = 0; i < 5; i++)
                {                    
                    if (o.tablicaUstawionychPionkow[i] == j)
                    {
